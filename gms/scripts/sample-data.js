...
async function createSampleData() {
  try{
    ...
    // Insert sample gardens and store their ID's
    const gardenIdMap = {};
...
// In this code example, we built a Node.js script to populate our MongoDB database collections.