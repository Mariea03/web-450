 ...
 * File: garden.spec.js
 * Description: In this code example, we wrote three-unit tests to test the Garden model.
 */
...
describe('Garden Model Test', () => {
  ...
  it('should fail to create a garden with a description longer that 500 characters', async () => {
    const gardenData = {
      name: 'Rose Garden',
      location: 'Central Park',
