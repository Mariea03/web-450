...
export class MainLayoutComponent {
  ...
  salesReports = [
    ...
    { name: 'Sales by Salesperson', url: '/reports/sales/sales-by-salesperson'}, // Added link to sales by salesperson
    // Add more reports as needed
  ];

  agentPerformanceReports = [
    { name: 'Call Duration by Date Range', url: '/reports/agent-performance/call-duration-by-date-range' },
    { name: 'Agent Performance by Team', url: '/reports/agent-performance/by-team'}
    // Add more reports as needed
  ];

  customerFeedbackReports = [
    { name: 'Channel Rating by Month', url: '/reports/customer-feedback/channel-rating-by-month' },
    { name: 'Customer Feedback by Agent', url: '/reports/customer-feedback/customer-feedback-by-agent' }
    // Add more reports as needed
  ];
